...
func (s *profileService) validateUsernameUniqueness(ctx context.Context, username string, userType model.UserType, organizationID *xid.ID, excludeUserID *xid.ID) error {
