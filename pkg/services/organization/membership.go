...
type MembershipService interface {
	...
	UpdateMemberStatus(ctx context.Context, organizationID, userID xid.ID, status model.MembershipStatus) (*model.Membership, error)
...
func (s *membershipService) UpdateMemberStatus(ctx context.Context, organizationID, userID xid.ID, status model.MembershipStatus) (*model.Membership, error) {
	// Get existing membership
