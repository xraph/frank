...
type Repository interface {
	...
	Update(ctx context.Context, id xid.ID, input RepositoryUpdateInput) (*ent.Organization, error)

	// Delete deletes an organization
	Delete(ctx context.Context, id xid.ID) error

	// GetMembers retrieves members of an organization
	GetMembers(ctx context.Context, orgID xid.ID, input RepositoryListInput) ([]*ent.User, int, error)
...
// GetByID retrieves an organization by ID
func (r *repository) GetByID(ctx context.Context, id xid.ID) (*ent.Organization, error) {
...
// Update updates an organization
func (r *repository) Update(ctx context.Context, id xid.ID, input RepositoryUpdateInput) (*ent.Organization, error) {
...
// GetMembers retrieves members of an organization
func (r *repository) GetMembers(ctx context.Context, orgID xid.ID, input RepositoryListInput) ([]*ent.User, int, error) {
	// Check if organization exists
	exists, err := r.client.Organization.
		Query().
...
// AddMember adds a user to an organization
func (r *repository) AddMember(ctx context.Context, orgID, userID xid.ID, roles []string) error {
	// Check if organization exists
...
// RemoveMember removes a user from an organization
func (r *repository) RemoveMember(ctx context.Context, orgID, userID xid.ID) error {
	// Check if organization exists
...
// UpdateMember updates a member's roles in an organization
func (r *repository) UpdateMember(ctx context.Context, orgID, userID xid.ID, roles []string) error {
	// Check if organization exists
	orgExists, err := r.client.Organization.
		Query().
		Where(organization.ID(orgID)).
...
// IsFeatureEnabled checks if a feature is enabled for an organization
func (r *repository) IsFeatureEnabled(ctx context.Context, orgID xid.ID, featureKey string) (bool, error) {
	// Check if organization exists
	orgExists, err := r.client.Organization.
		Query().
		Where(organization.ID(orgID)).
...
// GetFeatures retrieves features of an organization
func (r *repository) GetFeatures(ctx context.Context, orgID xid.ID) ([]*ent.OrganizationFeature, error) {
	// Check if organization exists
	orgExists, err := r.client.Organization.
		Query().
		Where(organization.ID(orgID)).
...
// EnableFeature enables a feature for an organization
func (r *repository) EnableFeature(ctx context.Context, orgID xid.ID, featureKey string, settings map[string]interface{}) error {
	// Check if organization exists
	orgExists, err := r.client.Organization.
		Query().
		Where(organization.ID(orgID)).
...
// DisableFeature disables a feature for an organization
func (r *repository) DisableFeature(ctx context.Context, orgID xid.ID, featureKey string) error {
	// Check if organization exists
	orgExists, err := r.client.Organization.
		Query().
		Where(organization.ID(orgID)).
