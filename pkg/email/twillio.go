...
func NewTwillioSender(cfg *config.EmailConfig, logger logging.Logger) Sender {
...
func (s *TwillioSender) SendBulkEmails(ctx context.Context, emails []Email) (*BulkEmailResult, error) {
	// TODO implement me
	panic("implement me")
}

func (s *TwillioSender) TestConnection(ctx context.Context) error {
	// TODO implement me
	panic("implement me")
}

func (s *TwillioSender) GetDeliveryStatus(ctx context.Context, messageID string) (*DeliveryInfo, error) {
	// TODO implement me
	panic("implement me")
}

func (s *TwillioSender) Name() string {
	return "twillio"
}
