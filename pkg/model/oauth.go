...
type TokenUsageStats struct {
	...
	DailyBreakdown  []OAuthDailyUsage `json:"dailyBreakdown"`
...
// APIKeyDailyUsage represents daily usage statistics
type APIKeyDailyUsage struct {
	...
	RateLimitedReason  string    `json:"rateLimitedReason"`
	ActiveUsers        int       `json:"activeUsers"`
	SuccessRate        float64   `json:"successRate"`
}

// APIKeyUsageTrends represents daily usage statistics
type APIKeyUsageTrends struct {
	Daily []APIKeyDailyUsage `json:"daily" doc:"Daily usage statistics"`
}
