...
const SampleFormContent = ({ isSubmitting = false }: { isSubmitting?: boolean }) => (
...
export const SuccessState: Story = {
    args: {
        ...
        success: 'Welcome to Frank Auth! Please check your email to verify your account.',
        variant: 'shadow',
        size: 'md',
        width: 'md',
        showCard: true,
    ...
    args: {
        ...
        header: (
            <div className="text-center">
                ...
                <p className="text-default-500 mt-2">Multi-factor authentication required</p>
            </div>
        ),
        footer: (
