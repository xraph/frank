...
export function SignUpModal({
    ...
    if (CustomSignUpModal) {
        return <CustomSignUpModal {...{
            isOpen, onClose, modalSize, closeOnBackdropClick, closeOnEscape,
            modalClassName, showCloseButton, methods, email, organizationId,
            invitationToken, redirectUrl, onSuccess, onError, title, subtitle,
            size, showBranding, disabled, requireTerms, termsUrl, privacyUrl,
            backdrop, placement
        }} />;
    }
    ...
    return (
        <>
            ...
            <SignUpModal
                ...
                invitationToken={modalData?.invitationToken || modalProps.invitationToken}
            />
        </>
    );
}
 ...
 */
export interface OrganizationInviteModalProps extends Omit<SignUpModalProps, 'invitationToken' | 'organizationId'> {
    /**
     * Invitation token
     */
    invitationToken: string;
