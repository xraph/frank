...
import {ArrowRightIcon, SparklesIcon, UserIcon, UserPlusIcon} from '@heroicons/react/24/outline';
...
export function SignUpButton({
    ...
    if (CustomSignUpButton) {
        return <CustomSignUpButton {...{
            ...
            disabled, loading, showAuthenticatedState, iconOnly, redirectAfterSignUp,
            autoRedirect
        }} />;
    }
    ...
    const defaultStartContent = startContent || (
        iconOnly ? <UserPlusIcon className="w-4 h-4" /> : <UserPlusIcon className="w-4 h-4" />
    );
 ...
 */
export function PrimarySignUpButton(props: Omit<SignUpButtonProps, 'variant' | 'color'>) {
    return (
        <SignUpButton
            {...props}
            variant="solid"
 ...
 */
export function SecondarySignUpButton(props: Omit<SignUpButtonProps, 'variant' | 'color'>) {
    return (
        <SignUpButton
            {...props}
            variant="bordered"
 ...
 */
export function SuccessSignUpButton(props: Omit<SignUpButtonProps, 'variant' | 'color'>) {
    return (
        <SignUpButton
            {...props}
            variant="solid"
    ...
    return (
        <SignUpButton
            ...
            modalProps={{
                ...
                organizationId,
                invitationToken,
                title: organizationName ? `Join ${organizationName}` : 'Join Organization',
                showBranding: true,
            }}
        >
            {content}
