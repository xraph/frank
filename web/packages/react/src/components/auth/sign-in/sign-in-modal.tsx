...
export function SignInModal({
    ...
    if (CustomSignInModal) {
        return <CustomSignInModal {...{
            isOpen, onClose, modalSize, closeOnBackdropClick, closeOnEscape,
            modalClassName, showCloseButton, methods, email, organizationId,
            redirectUrl, onSuccess, onError, title, subtitle, size, showBranding,
            disabled, showSignUpLink, showForgotPasswordLink, footer, header,
            backdrop, placement, modalHeader, modalFooter, hideHeader, hideFooter,
            scrollBehavior
        }} />;
    }
