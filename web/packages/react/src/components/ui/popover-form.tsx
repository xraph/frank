...
export function PopoverForm({
  ...
  useClickOutside(ref as any, () => setOpen(false))
  ...
  return (
    ...
    >
      <motion.button
        ...
        className="flex h-9 items-center border bg-white px-3 font-medium text-sm outline-none dark:bg-[#121212]"
      >
      ...
      <AnimatePresence>
        {open && (
          <motion.div
            layoutId={`${title}-wrapper`}
            className="absolute z-50 overflow-hidden bg-muted p-1 shadow-[0_0_0_1px_rgba(0,0,0,0.08),0px_1px_2px_rgba(0,0,0,0.04)] outline-none"
            ref={ref}
            style={{ borderRadius: 10, width, height }}
          >
            <motion.span
              aria-hidden
              className="absolute top-[17px] left-4 text-muted-foreground text-sm data-[success]:text-transparent"
            ...
            {showCloseButton && (
              <div className="-top-[5px] -translate-x-1/2 absolute left-1/2 z-20 flex h-[26px] w-[12px] transform items-center justify-center">
                <button
                  type="button"
                  onClick={() => setOpen(false)}
                  className="-mt-1 absolute z-10 flex h-[6px] w-[10px] items-center justify-center rounded-full text-muted-foreground hover:text-foreground focus:outline-none "
                  aria-label="Close"
                >
...
export function PopoverFormButton({
  ...
  return (
    <button
      type="submit"
      className="ml-auto flex h-6 w-26 items-center justify-center overflow-hidden rounded-md bg-gradient-to-b from-primary/90 to-primary px-3 font-semibold text-primary-foreground text-xs shadow-[0_0_1px_1px_rgba(255,255,255,0.08)_inset,0_1px_1.5px_0_rgba(0,0,0,0.32),0_0_0_0.5px_#1a94ff]"
    >
...
export function PopoverFormSuccess({
  ...
  return (
    <>
      ...
      >
        <title id="successIconTitle">Submission successful</title>
        <path
      ...
      <h3 className="mt-2 mb-1 font-medium text-primary text-sm">{title}</h3>
      <p className="mx-auto max-w-xs text-pretty text-center text-muted-foreground text-sm">
        {description}
      </p>
    </>
  )
...
export function PopoverFormSeparator({
  ...
  return (
    <svg
      ...
      fill="none"
      xmlns="http://www.w3.org/2000/svg"
      aria-labelledby="separatorTitle"
    >
      <title id="separatorTitle">Decorative separator line</title>
...
function PopoverFormCutOutTopIcon({
  ...
  return (
    <svg
      ...
      aria-labelledby="cutOutTopIconTitle"
    >
      <title id="cutOutTopIconTitle">Cut out decorative icon</title>
...
export function PopoverFormCutOutLeftIcon() {
  return (
    <svg
      ...
      fill="none"
      xmlns="http://www.w3.org/2000/svg"
      aria-labelledby="cutOutLeftIconTitle"
    >
      <title id="cutOutLeftIconTitle">Cut out decorative left icon</title>
      <g clipPath="url(#clip0_2029_22)">
        <path
          d="M0 2C0.656613 2 1.30679 2.10346 1.91341 2.30448C2.52005 2.5055 3.07124 2.80014 3.53554 3.17157C3.99982 3.54301 4.36812 3.98396 4.6194 4.46927C4.87067 4.95457 5 5.47471 5 6C5 6.52529 4.87067 7.04543 4.6194 7.53073C4.36812 8.01604 3.99982 8.45699 3.53554 8.82843C3.07124 9.19986 2.52005 9.4945 1.91341 9.69552C1.30679 9.89654 0.656613 10 0 10V6V2Z"
          className="fill-muted"
...
export function PopoverFormCutOutRightIcon() {
  return (
    <svg
      ...
      fill="none"
      xmlns="http://www.w3.org/2000/svg"
      aria-labelledby="cutOutRightIconTitle"
    >
      <title id="cutOutRightIconTitle">Cut out decorative right icon</title>
      <g clipPath="url(#clip0_2029_22)">
        <path
          d="M0 2C0.656613 2 1.30679 2.10346 1.91341 2.30448C2.52005 2.5055 3.07124 2.80014 3.53554 3.17157C3.99982 3.54301 4.36812 3.98396 4.6194 4.46927C4.87067 4.95457 5 5.47471 5 6C5 6.52529 4.87067 7.04543 4.6194 7.53073C4.36812 8.01604 3.99982 8.45699 3.53554 8.82843C3.07124 9.19986 2.52005 9.4945 1.91341 9.69552C1.30679 9.89654 0.656613 10 0 10V6V2Z"
          className="fill-muted"
