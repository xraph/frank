    ...
    switch (environment) {
        ...
        case 'server':
            if (context) {
                ...
                const serverCookieContext = new NextJSCookieContext(context.req, context.res);
...
export class HybridAuthStorage {
    ...
    constructor(prefix?: string, serverContext?: { req: any; res: any }) {
        if (serverContext) {
            ...
            this.serverStorage = createAuthStorageForEnvironment('server', prefix, serverContext);
