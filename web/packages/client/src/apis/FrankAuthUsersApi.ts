...
/**
 * FrankAuthUsersApi - interface
 * 
 * @export
 * @interface FrankAuthUsersApiInterface
 */
export interface FrankAuthUsersApiInterface {
    /**
     ...
     * @memberof FrankAuthUsersApiInterface
     */
 ...
 * 
 */
export class FrankAuthUsersApi extends runtime.BaseAPI implements FrankAuthUsersApiInterface {
