...
/**
 * FrankAuthMembersApi - interface
 * 
 * @export
 * @interface FrankAuthMembersApiInterface
 */
export interface FrankAuthMembersApiInterface {
    /**
     ...
     * @memberof FrankAuthMembersApiInterface
     */
 ...
 * 
 */
export class FrankAuthMembersApi extends runtime.BaseAPI implements FrankAuthMembersApiInterface {
