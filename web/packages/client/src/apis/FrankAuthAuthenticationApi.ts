...
/**
 * FrankAuthAuthenticationApi - interface
 * 
 * @export
 * @interface FrankAuthAuthenticationApiInterface
 */
export interface FrankAuthAuthenticationApiInterface {
    /**
     * Get current user authentication status and context
     * @summary Get authentication status
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     * @memberof FrankAuthAuthenticationApiInterface
     */
 ...
 * 
 */
export class FrankAuthAuthenticationApi extends runtime.BaseAPI implements FrankAuthAuthenticationApiInterface {
