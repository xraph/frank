...
func main() {
	...
	{
		fmt.Println("scheme:", scheme, "host:", host, "timeout:", timeout, "debug:", debug)
		switch scheme {
		case "http", "https":
...
func usage() {
	fmt.Fprintf(os.Stderr, `%s is a command line client for the interceptors API.
