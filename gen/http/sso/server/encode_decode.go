...
// marshalSsoUserToUserResponseBody builds a value of type *UserResponseBody
// from a value of type *sso.User.
func marshalSsoUserToUserResponseBody(v *sso.User) *UserResponseBody {
	if v == nil {
		return nil
	}
