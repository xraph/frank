...
// marshalOauthclientUserToUserResponseBody builds a value of type
// *UserResponseBody from a value of type *oauthclient.User.
func marshalOauthclientUserToUserResponseBody(v *oauthclient.User) *UserResponseBody {
	if v == nil {
		return nil
	}
