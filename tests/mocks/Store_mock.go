...
func (m *MockSessionStore) GetSession(arg0 context.Context, arg1 string) (*session.Session, error) {
	m.ctrl.T.Helper()
...
func (m *MockSessionStore) StoreSession(arg0 context.Context, arg1 string, arg2 *session.Session, arg3 time.Duration) error {
	m.ctrl.T.Helper()
...
func (m *MockSessionStore) UpdateSession(arg0 context.Context, arg1 string, arg2 *session.Session) error {
	m.ctrl.T.Helper()
