...
func (*OAuthClient) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case oauthclient.FieldID, oauthclient.FieldClientID, oauthclient.FieldClientSecret, oauthclient.FieldClientName, oauthclient.FieldClientDescription, oauthclient.FieldClientURI, oauthclient.FieldLogoURI, oauthclient.FieldOrganizationID:
	...
	for i := range columns {
		...
		case oauthclient.FieldOrganizationID:
			if value, ok := values[i].(*sql.NullString); !ok {
				...
				oc.OrganizationID = value.String
			}
...
func (oc *OAuthClient) String() string {
	...
	builder.WriteString(oc.OrganizationID)
	builder.WriteString(", ")
