...
func (ipq *IdentityProviderQuery) FirstID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (ipq *IdentityProviderQuery) FirstIDX(ctx context.Context) string {
...
func (ipq *IdentityProviderQuery) OnlyID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (ipq *IdentityProviderQuery) OnlyIDX(ctx context.Context) string {
...
func (ipq *IdentityProviderQuery) IDs(ctx context.Context) (ids []string, err error) {
...
func (ipq *IdentityProviderQuery) IDsX(ctx context.Context) []string {
	ids, err := ipq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (ipq *IdentityProviderQuery) loadOrganization(ctx context.Context, query *OrganizationQuery, nodes []*IdentityProvider, init func(*IdentityProvider), assign func(*IdentityProvider, *Organization)) error {
	...
	nodeids := make(map[string][]*IdentityProvider)
	for i := range nodes {
