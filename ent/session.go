...
func (*Session) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case session.FieldID, session.FieldUserID, session.FieldToken, session.FieldIPAddress, session.FieldUserAgent, session.FieldDeviceID, session.FieldLocation, session.FieldOrganizationID:
