...
func (aq *AuditQuery) QueryOrganization() *OrganizationQuery {
...
func (aq *AuditQuery) QuerySession() *SessionQuery {
...
func (aq *AuditQuery) FirstID(ctx context.Context) (id xid.ID, err error) {
	var ids []xid.ID
...
func (aq *AuditQuery) FirstIDX(ctx context.Context) xid.ID {
...
func (aq *AuditQuery) OnlyID(ctx context.Context) (id xid.ID, err error) {
	var ids []xid.ID
...
func (aq *AuditQuery) OnlyIDX(ctx context.Context) xid.ID {
...
func (aq *AuditQuery) IDs(ctx context.Context) (ids []xid.ID, err error) {
...
func (aq *AuditQuery) IDsX(ctx context.Context) []xid.ID {
	ids, err := aq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (aq *AuditQuery) WithOrganization(opts ...func(*OrganizationQuery)) *AuditQuery {
	query := (&OrganizationClient{config: aq.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (aq *AuditQuery) WithSession(opts ...func(*SessionQuery)) *AuditQuery {
	query := (&SessionClient{config: aq.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (aq *AuditQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Audit, error) {
	...
	if query := aq.withOrganization; query != nil {
		if err := aq.loadOrganization(ctx, query, nodes, nil,
			func(n *Audit, e *Organization) { n.Edges.Organization = e }); err != nil {
			return nil, err
		}
	}
	if query := aq.withSession; query != nil {
		if err := aq.loadSession(ctx, query, nodes, nil,
			func(n *Audit, e *Session) { n.Edges.Session = e }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (aq *AuditQuery) loadOrganization(ctx context.Context, query *OrganizationQuery, nodes []*Audit, init func(*Audit), assign func(*Audit, *Organization)) error {
	ids := make([]xid.ID, 0, len(nodes))
	nodeids := make(map[xid.ID][]*Audit)
	for i := range nodes {
...
func (aq *AuditQuery) loadSession(ctx context.Context, query *SessionQuery, nodes []*Audit, init func(*Audit), assign func(*Audit, *Session)) error {
	ids := make([]xid.ID, 0, len(nodes))
	nodeids := make(map[xid.ID][]*Audit)
	for i := range nodes {
...
func (aq *AuditQuery) querySpec() *sqlgraph.QuerySpec {
	...
	if fields := aq.ctx.Fields; len(fields) > 0 {
		...
		if aq.withUser != nil {
			_spec.Node.AddColumnOnce(audit.FieldUserID)
		}
		if aq.withOrganization != nil {
			_spec.Node.AddColumnOnce(audit.FieldOrganizationID)
		}
		if aq.withSession != nil {
			_spec.Node.AddColumnOnce(audit.FieldSessionID)
		}
	}
...
func (aq *AuditQuery) ForUpdate(opts ...sql.LockOption) *AuditQuery {
...
func (aq *AuditQuery) ForShare(opts ...sql.LockOption) *AuditQuery {
	if aq.driver.Dialect() == dialect.Postgres {
		aq.Unique(false)
	}
	aq.modifiers = append(aq.modifiers, func(s *sql.Selector) {
...
func (aq *AuditQuery) Modify(modifiers ...func(s *sql.Selector)) *AuditSelect {
...
// Modify adds a query modifier for attaching custom logic to queries.
func (as *AuditSelect) Modify(modifiers ...func(s *sql.Selector)) *AuditSelect {
