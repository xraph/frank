...
func (*OAuthAuthorization) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case oauthauthorization.FieldID, oauthauthorization.FieldClientID, oauthauthorization.FieldUserID, oauthauthorization.FieldOrganizationID, oauthauthorization.FieldCode, oauthauthorization.FieldCodeChallenge, oauthauthorization.FieldCodeChallengeMethod, oauthauthorization.FieldRedirectURI, oauthauthorization.FieldState, oauthauthorization.FieldNonce:
	...
	for i := range columns {
		...
		case oauthauthorization.FieldOrganizationID:
			if value, ok := values[i].(*sql.NullString); !ok {
				...
				oa.OrganizationID = value.String
			}
...
func (oa *OAuthAuthorization) String() string {
	...
	builder.WriteString(oa.ClientID)
	builder.WriteString(", ")
	builder.WriteString("user_id=")
	builder.WriteString(oa.UserID)
	builder.WriteString(", ")
	builder.WriteString("organization_id=")
	builder.WriteString(oa.OrganizationID)
	builder.WriteString(", ")
