...
func (pu *PasskeyUpdate) SetUserID(s string) *PasskeyUpdate {
	pu.mutation.SetUserID(s)
	return pu
}

// SetNillableUserID sets the "user_id" field if the given value is not nil.
func (pu *PasskeyUpdate) SetNillableUserID(s *string) *PasskeyUpdate {
	if s != nil {
		pu.SetUserID(*s)
	}
	return pu
...
// SetUserID sets the "user_id" field.
func (puo *PasskeyUpdateOne) SetUserID(s string) *PasskeyUpdateOne {
	puo.mutation.SetUserID(s)
	return puo
}

// SetNillableUserID sets the "user_id" field if the given value is not nil.
func (puo *PasskeyUpdateOne) SetNillableUserID(s *string) *PasskeyUpdateOne {
	if s != nil {
		puo.SetUserID(*s)
	}
	return puo
