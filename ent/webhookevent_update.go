...
func (weu *WebhookEventUpdate) SetNillableWebhookID(s *string) *WebhookEventUpdate {
	if s != nil {
		weu.SetWebhookID(*s)
	}
	return weu
...
// SetWebhookID sets the "webhook_id" field.
func (weuo *WebhookEventUpdateOne) SetWebhookID(s string) *WebhookEventUpdateOne {
	weuo.mutation.SetWebhookID(s)
	return weuo
}

// SetNillableWebhookID sets the "webhook_id" field if the given value is not nil.
func (weuo *WebhookEventUpdateOne) SetNillableWebhookID(s *string) *WebhookEventUpdateOne {
	if s != nil {
		weuo.SetWebhookID(*s)
	}
	return weuo
