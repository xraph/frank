...
type WebhookQuery struct {
	...
	withNamedEvents  map[string]*WebhookEventQuery
...
func (wq *WebhookQuery) QueryOrganization() *OrganizationQuery {
...
func (wq *WebhookQuery) QueryEvents() *WebhookEventQuery {
	query := (&WebhookEventClient{config: wq.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := wq.prepareQuery(ctx); err != nil {
			return nil, err
		}
...
func (wq *WebhookQuery) FirstID(ctx context.Context) (id xid.ID, err error) {
	var ids []xid.ID
...
func (wq *WebhookQuery) FirstIDX(ctx context.Context) xid.ID {
...
func (wq *WebhookQuery) OnlyID(ctx context.Context) (id xid.ID, err error) {
	var ids []xid.ID
...
func (wq *WebhookQuery) OnlyIDX(ctx context.Context) xid.ID {
...
func (wq *WebhookQuery) IDs(ctx context.Context) (ids []xid.ID, err error) {
...
func (wq *WebhookQuery) IDsX(ctx context.Context) []xid.ID {
	ids, err := wq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (wq *WebhookQuery) WithOrganization(opts ...func(*OrganizationQuery)) *WebhookQuery {
	query := (&OrganizationClient{config: wq.config}).Query()
...
func (wq *WebhookQuery) WithEvents(opts ...func(*WebhookEventQuery)) *WebhookQuery {
	query := (&WebhookEventClient{config: wq.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (wq *WebhookQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Webhook, error) {
	...
	if query := wq.withOrganization; query != nil {
		if err := wq.loadOrganization(ctx, query, nodes, nil,
			func(n *Webhook, e *Organization) { n.Edges.Organization = e }); err != nil {
			return nil, err
		}
	}
	if query := wq.withEvents; query != nil {
		if err := wq.loadEvents(ctx, query, nodes,
			func(n *Webhook) { n.Edges.Events = []*WebhookEvent{} },
			func(n *Webhook, e *WebhookEvent) {
...
func (wq *WebhookQuery) loadOrganization(ctx context.Context, query *OrganizationQuery, nodes []*Webhook, init func(*Webhook), assign func(*Webhook, *Organization)) error {
	ids := make([]xid.ID, 0, len(nodes))
	nodeids := make(map[xid.ID][]*Webhook)
	for i := range nodes {
...
func (wq *WebhookQuery) loadEvents(ctx context.Context, query *WebhookEventQuery, nodes []*Webhook, init func(*Webhook), assign func(*Webhook, *WebhookEvent)) error {
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(webhookevent.FieldWebhookID)
	}
	query.Where(predicate.WebhookEvent(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(webhook.EventsColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (wq *WebhookQuery) querySpec() *sqlgraph.QuerySpec {
	...
	if fields := wq.ctx.Fields; len(fields) > 0 {
		...
		if wq.withOrganization != nil {
			_spec.Node.AddColumnOnce(webhook.FieldOrganizationID)
		}
	}
...
func (wq *WebhookQuery) ForUpdate(opts ...sql.LockOption) *WebhookQuery {
...
func (wq *WebhookQuery) ForShare(opts ...sql.LockOption) *WebhookQuery {
	if wq.driver.Dialect() == dialect.Postgres {
		wq.Unique(false)
	}
	wq.modifiers = append(wq.modifiers, func(s *sql.Selector) {
...
func (wq *WebhookQuery) WithNamedEvents(name string, opts ...func(*WebhookEventQuery)) *WebhookQuery {
	query := (&WebhookEventClient{config: wq.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	if wq.withNamedEvents == nil {
		wq.withNamedEvents = make(map[string]*WebhookEventQuery)
	}
