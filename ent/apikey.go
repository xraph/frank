...
func (*ApiKey) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case apikey.FieldID, apikey.FieldName, apikey.FieldKey, apikey.FieldHashedKey, apikey.FieldUserID, apikey.FieldOrganizationID, apikey.FieldType:
	...
	for i := range columns {
		...
		case apikey.FieldOrganizationID:
			if value, ok := values[i].(*sql.NullString); !ok {
				...
				ak.OrganizationID = value.String
			}
...
func (ak *ApiKey) String() string {
	...
	builder.WriteString(ak.OrganizationID)
	builder.WriteString(", ")
