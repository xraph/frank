...
func (urq *UserRoleQuery) QueryOrganizationContext() *OrganizationQuery {
...
func (urq *UserRoleQuery) QueryAssignedByUser() *UserQuery {
	query := (&UserClient{config: urq.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := urq.prepareQuery(ctx); err != nil {
			return nil, err
...
func (urq *UserRoleQuery) FirstID(ctx context.Context) (id xid.ID, err error) {
	var ids []xid.ID
...
func (urq *UserRoleQuery) FirstIDX(ctx context.Context) xid.ID {
...
func (urq *UserRoleQuery) OnlyID(ctx context.Context) (id xid.ID, err error) {
	var ids []xid.ID
...
func (urq *UserRoleQuery) OnlyIDX(ctx context.Context) xid.ID {
...
func (urq *UserRoleQuery) IDs(ctx context.Context) (ids []xid.ID, err error) {
...
func (urq *UserRoleQuery) IDsX(ctx context.Context) []xid.ID {
	ids, err := urq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (urq *UserRoleQuery) Clone() *UserRoleQuery {
	...
	return &UserRoleQuery{
		...
		withOrganizationContext: urq.withOrganizationContext.Clone(),
		withAssignedByUser:      urq.withAssignedByUser.Clone(),
...
func (urq *UserRoleQuery) WithOrganizationContext(opts ...func(*OrganizationQuery)) *UserRoleQuery {
	query := (&OrganizationClient{config: urq.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	urq.withOrganizationContext = query
	return urq
}
...
func (urq *UserRoleQuery) WithAssignedByUser(opts ...func(*UserQuery)) *UserRoleQuery {
	query := (&UserClient{config: urq.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	urq.withAssignedByUser = query
	return urq
}
...
func (urq *UserRoleQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*UserRole, error) {
	var (
		...
		loadedTypes = [4]bool{
			urq.withUser != nil,
			urq.withRole != nil,
			urq.withOrganizationContext != nil,
			urq.withAssignedByUser != nil,
		}
	)
	...
	if query := urq.withOrganizationContext; query != nil {
		if err := urq.loadOrganizationContext(ctx, query, nodes, nil,
			func(n *UserRole, e *Organization) { n.Edges.OrganizationContext = e }); err != nil {
			return nil, err
		}
	}
	if query := urq.withAssignedByUser; query != nil {
		if err := urq.loadAssignedByUser(ctx, query, nodes, nil,
			func(n *UserRole, e *User) { n.Edges.AssignedByUser = e }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (urq *UserRoleQuery) loadUser(ctx context.Context, query *UserQuery, nodes []*UserRole, init func(*UserRole), assign func(*UserRole, *User)) error {
	...
	nodeids := make(map[xid.ID][]*UserRole)
	for i := range nodes {
		fk := nodes[i].UserID
...
func (urq *UserRoleQuery) loadOrganizationContext(ctx context.Context, query *OrganizationQuery, nodes []*UserRole, init func(*UserRole), assign func(*UserRole, *Organization)) error {
	ids := make([]xid.ID, 0, len(nodes))
	nodeids := make(map[xid.ID][]*UserRole)
	for i := range nodes {
...
func (urq *UserRoleQuery) loadAssignedByUser(ctx context.Context, query *UserQuery, nodes []*UserRole, init func(*UserRole), assign func(*UserRole, *User)) error {
	ids := make([]xid.ID, 0, len(nodes))
	nodeids := make(map[xid.ID][]*UserRole)
	for i := range nodes {
...
func (urq *UserRoleQuery) querySpec() *sqlgraph.QuerySpec {
	...
	if fields := urq.ctx.Fields; len(fields) > 0 {
		...
		if urq.withOrganizationContext != nil {
			_spec.Node.AddColumnOnce(userrole.FieldContextID)
		}
		if urq.withAssignedByUser != nil {
			_spec.Node.AddColumnOnce(userrole.FieldAssignedBy)
		}
	}
