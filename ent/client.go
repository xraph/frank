...
func (c *Client) Use(hooks ...Hook) {
	for _, n := range []interface{ Use(...Hook) }{
		...
		c.OAuthAuthorization, c.OAuthClient, c.OAuthScope, c.OAuthToken,
		c.Organization, c.OrganizationFeature, c.Passkey, c.Permission, c.Role,
		c.SSOState, c.Session, c.User, c.Verification, c.Webhook, c.WebhookEvent,
	} {
		n.Use(hooks...)
	}
}
...
// QueryOrganizations queries the organizations edge of a FeatureFlag.
func (c *FeatureFlagClient) QueryOrganizations(ff *FeatureFlag) *OrganizationFeatureQuery {
	...
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		...
		step := sqlgraph.NewStep(
			...
			sqlgraph.Edge(sqlgraph.O2M, true, featureflag.OrganizationsTable, featureflag.OrganizationsColumn),
		)
...
// UpdateOneID returns an update builder for the given id.
func (c *MFAClient) UpdateOneID(id string) *MFAUpdateOne {
...
// DeleteOneID returns a builder for deleting the given entity by its id.
func (c *MFAClient) DeleteOneID(id string) *MFADeleteOne {
...
func (c *MFAClient) Get(ctx context.Context, id string) (*MFA, error) {
	return c.Query().Where(mfa.ID(id)).Only(ctx)
}

// GetX is like Get, but panics if an error occurs.
func (c *MFAClient) GetX(ctx context.Context, id string) *MFA {
	obj, err := c.Get(ctx, id)
	if err != nil {
		panic(err)
	}
...
// UpdateOneID returns an update builder for the given id.
func (c *OAuthScopeClient) UpdateOneID(id string) *OAuthScopeUpdateOne {
...
// DeleteOneID returns a builder for deleting the given entity by its id.
func (c *OAuthScopeClient) DeleteOneID(id string) *OAuthScopeDeleteOne {
...
func (c *OAuthScopeClient) Get(ctx context.Context, id string) (*OAuthScope, error) {
	return c.Query().Where(oauthscope.ID(id)).Only(ctx)
}

// GetX is like Get, but panics if an error occurs.
func (c *OAuthScopeClient) GetX(ctx context.Context, id string) *OAuthScope {
	obj, err := c.Get(ctx, id)
	if err != nil {
		panic(err)
	}
...
// UpdateOneID returns an update builder for the given id.
func (c *OrganizationFeatureClient) UpdateOneID(id string) *OrganizationFeatureUpdateOne {
...
// DeleteOneID returns a builder for deleting the given entity by its id.
func (c *OrganizationFeatureClient) DeleteOneID(id string) *OrganizationFeatureDeleteOne {
...
func (c *OrganizationFeatureClient) Get(ctx context.Context, id string) (*OrganizationFeature, error) {
	return c.Query().Where(organizationfeature.ID(id)).Only(ctx)
}

// GetX is like Get, but panics if an error occurs.
func (c *OrganizationFeatureClient) GetX(ctx context.Context, id string) *OrganizationFeature {
	obj, err := c.Get(ctx, id)
	if err != nil {
		panic(err)
	}
...
// UpdateOneID returns an update builder for the given id.
func (c *PasskeyClient) UpdateOneID(id string) *PasskeyUpdateOne {
...
// DeleteOneID returns a builder for deleting the given entity by its id.
func (c *PasskeyClient) DeleteOneID(id string) *PasskeyDeleteOne {
...
func (c *PasskeyClient) Get(ctx context.Context, id string) (*Passkey, error) {
	return c.Query().Where(passkey.ID(id)).Only(ctx)
}

// GetX is like Get, but panics if an error occurs.
func (c *PasskeyClient) GetX(ctx context.Context, id string) *Passkey {
	obj, err := c.Get(ctx, id)
	if err != nil {
		panic(err)
	}
...
// UpdateOneID returns an update builder for the given id.
func (c *SSOStateClient) UpdateOneID(id string) *SSOStateUpdateOne {
...
// DeleteOneID returns a builder for deleting the given entity by its id.
func (c *SSOStateClient) DeleteOneID(id string) *SSOStateDeleteOne {
...
func (c *SSOStateClient) Get(ctx context.Context, id string) (*SSOState, error) {
	return c.Query().Where(ssostate.ID(id)).Only(ctx)
}

// GetX is like Get, but panics if an error occurs.
func (c *SSOStateClient) GetX(ctx context.Context, id string) *SSOState {
	obj, err := c.Get(ctx, id)
	if err != nil {
		panic(err)
	}
...
type (
	hooks struct {
		ApiKey, EmailTemplate, FeatureFlag, IdentityProvider, MFA, OAuthAuthorization,
		OAuthClient, OAuthScope, OAuthToken, Organization, OrganizationFeature,
		Passkey, Permission, Role, SSOState, Session, User, Verification, Webhook,
