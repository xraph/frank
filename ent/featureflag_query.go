...
type FeatureFlagQuery struct {
	...
	withOrganizations *OrganizationFeatureQuery
...
func (ffq *FeatureFlagQuery) QueryOrganizations() *OrganizationFeatureQuery {
...
func (ffq *FeatureFlagQuery) FirstID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (ffq *FeatureFlagQuery) FirstIDX(ctx context.Context) string {
...
func (ffq *FeatureFlagQuery) OnlyID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (ffq *FeatureFlagQuery) OnlyIDX(ctx context.Context) string {
...
func (ffq *FeatureFlagQuery) IDs(ctx context.Context) (ids []string, err error) {
...
func (ffq *FeatureFlagQuery) IDsX(ctx context.Context) []string {
	ids, err := ffq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (ffq *FeatureFlagQuery) Clone() *FeatureFlagQuery {
	...
	return &FeatureFlagQuery{
		...
		withOrganizations: ffq.withOrganizations.Clone(),
...
func (ffq *FeatureFlagQuery) WithOrganizations(opts ...func(*OrganizationFeatureQuery)) *FeatureFlagQuery {
	query := (&OrganizationFeatureClient{config: ffq.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	ffq.withOrganizations = query
	return ffq
}
...
func (ffq *FeatureFlagQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*FeatureFlag, error) {
	...
	if query := ffq.withOrganizations; query != nil {
		if err := ffq.loadOrganizations(ctx, query, nodes,
			func(n *FeatureFlag) { n.Edges.Organizations = []*OrganizationFeature{} },
			func(n *FeatureFlag, e *OrganizationFeature) { n.Edges.Organizations = append(n.Edges.Organizations, e) }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (ffq *FeatureFlagQuery) loadOrganizations(ctx context.Context, query *OrganizationFeatureQuery, nodes []*FeatureFlag, init func(*FeatureFlag), assign func(*FeatureFlag, *OrganizationFeature)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[string]*FeatureFlag)
	for i := range nodes {
	...
	query.Where(predicate.OrganizationFeature(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(featureflag.OrganizationsColumn), fks...))
	}))
