...
func (ssu *SSOStateUpdate) Modify(modifiers ...func(u *sql.UpdateBuilder)) *SSOStateUpdate {
...
// Modify adds a statement modifier for attaching custom logic to the UPDATE statement.
func (ssuo *SSOStateUpdateOne) Modify(modifiers ...func(u *sql.UpdateBuilder)) *SSOStateUpdateOne {
