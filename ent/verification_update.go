...
func (vu *VerificationUpdate) SetUserID(s string) *VerificationUpdate {
	vu.mutation.SetUserID(s)
	return vu
}

// SetNillableUserID sets the "user_id" field if the given value is not nil.
func (vu *VerificationUpdate) SetNillableUserID(s *string) *VerificationUpdate {
	if s != nil {
		vu.SetUserID(*s)
	}
	return vu
...
// SetUserID sets the "user_id" field.
func (vuo *VerificationUpdateOne) SetUserID(s string) *VerificationUpdateOne {
	vuo.mutation.SetUserID(s)
	return vuo
}

// SetNillableUserID sets the "user_id" field if the given value is not nil.
func (vuo *VerificationUpdateOne) SetNillableUserID(s *string) *VerificationUpdateOne {
	if s != nil {
		vuo.SetUserID(*s)
	}
	return vuo
