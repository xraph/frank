...
func (*OAuthToken) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case oauthtoken.FieldID, oauthtoken.FieldAccessToken, oauthtoken.FieldRefreshToken, oauthtoken.FieldTokenType, oauthtoken.FieldClientID, oauthtoken.FieldUserID, oauthtoken.FieldOrganizationID, oauthtoken.FieldIPAddress, oauthtoken.FieldUserAgent:
...
func (ot *OAuthToken) String() string {
	...
	builder.WriteString(ot.ClientID)
	builder.WriteString(", ")
	builder.WriteString("user_id=")
	builder.WriteString(ot.UserID)
	builder.WriteString(", ")
	builder.WriteString("organization_id=")
	builder.WriteString(ot.OrganizationID)
	builder.WriteString(", ")
