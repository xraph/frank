...
func (sq *SessionQuery) FirstID(ctx context.Context) (id xid.ID, err error) {
	var ids []xid.ID
...
func (sq *SessionQuery) FirstIDX(ctx context.Context) xid.ID {
...
func (sq *SessionQuery) OnlyID(ctx context.Context) (id xid.ID, err error) {
	var ids []xid.ID
...
func (sq *SessionQuery) OnlyIDX(ctx context.Context) xid.ID {
...
func (sq *SessionQuery) IDs(ctx context.Context) (ids []xid.ID, err error) {
...
func (sq *SessionQuery) IDsX(ctx context.Context) []xid.ID {
	ids, err := sq.IDs(ctx)
	if err != nil {
		panic(err)
	}
