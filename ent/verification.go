...
func (*Verification) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case verification.FieldID, verification.FieldUserID, verification.FieldType, verification.FieldToken, verification.FieldEmail, verification.FieldPhoneNumber, verification.FieldRedirectURL, verification.FieldIPAddress, verification.FieldUserAgent:
