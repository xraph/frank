...
func (wu *WebhookUpdate) SetOrganizationID(s string) *WebhookUpdate {
	wu.mutation.SetOrganizationID(s)
	return wu
}

// SetNillableOrganizationID sets the "organization_id" field if the given value is not nil.
func (wu *WebhookUpdate) SetNillableOrganizationID(s *string) *WebhookUpdate {
	if s != nil {
		wu.SetOrganizationID(*s)
	}
	return wu
}
...
// SetOrganizationID sets the "organization_id" field.
func (wuo *WebhookUpdateOne) SetOrganizationID(s string) *WebhookUpdateOne {
	wuo.mutation.SetOrganizationID(s)
	return wuo
}

// SetNillableOrganizationID sets the "organization_id" field if the given value is not nil.
func (wuo *WebhookUpdateOne) SetNillableOrganizationID(s *string) *WebhookUpdateOne {
	if s != nil {
		wuo.SetOrganizationID(*s)
	}
	return wuo
}
