...
func (*Webhook) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case webhook.FieldID, webhook.FieldName, webhook.FieldURL, webhook.FieldOrganizationID, webhook.FieldSecret, webhook.FieldVersion, webhook.FieldFormat:
...
func (w *Webhook) String() string {
	...
	builder.WriteString(w.OrganizationID)
	builder.WriteString(", ")
