...
type FeatureFlagEdges struct {
	...
	Organizations []*OrganizationFeature `json:"organizations,omitempty"`
...
func (e FeatureFlagEdges) OrganizationsOrErr() ([]*OrganizationFeature, error) {
	if e.loadedTypes[0] {
...
func (*FeatureFlag) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case featureflag.FieldID, featureflag.FieldName, featureflag.FieldKey, featureflag.FieldDescription, featureflag.FieldComponent:
...
// QueryOrganizations queries the "organizations" edge of the FeatureFlag entity.
func (ff *FeatureFlag) QueryOrganizations() *OrganizationFeatureQuery {
	return NewFeatureFlagClient(ff.config).QueryOrganizations(ff)
}
