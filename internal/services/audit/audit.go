...
func (s *auditService) GetAuditLogs(ctx context.Context, req model.AuditLogListRequest) (*model.AuditLogListResponse, error) {
	...
	params := s.convertListRequestToParams(req)

	result, err := s.auditRepo.ListByOrganizationID(ctx, req.OrganizationID.Value, params)
	if err != nil {
...
func (s *auditService) getIPFromContext(ctx context.Context) string {
	// Extract IP from context - implementation depends on your middleware
	return ""
}

func (s *auditService) getUserAgentFromContext(ctx context.Context) string {
	// Extract User-Agent from context - implementation depends on your middleware
	return ""
}
...
func (s *auditService) convertListRequestToParams(req model.AuditLogListRequest) model.PaginationParams {
	// Convert audit list request to pagination params
