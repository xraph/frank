...
// RoleService provides role-specific RBAC functionality
type RoleService interface {
	...
	GetSystemRoles(ctx context.Context, params ListRolesParams) (*model.PaginatedOutput[*model.Role], error)
	GetOrganizationRoles(ctx context.Context, organizationID xid.ID, params ListRolesParams) (*model.PaginatedOutput[*model.Role], error)
	GetApplicationRoles(ctx context.Context, applicationID xid.ID, params ListRolesParams) (*model.PaginatedOutput[*model.Role], error)
	...
	GetDefaultRoleForUserType(ctx context.Context, userType string, roleType role.RoleType, organizationID *xid.ID) (*model.Role, error)
	...
	// Role validation
	ValidateRoleName(ctx context.Context, name string, roleType role.RoleType, organizationID *xid.ID) error
	...
	GetRoleTemplates(ctx context.Context, roleType role.RoleType) ([]RoleTemplate, error)
	...
	// Bulk operations
	BulkCreateRoles(ctx context.Context, inputs []CreateRoleInput) ([]*model.Role, []error)
...
type BulkRoleUpdate struct {
	ID    xid.ID         `json:"id"`
	Input UpdateRoleBody `json:"input"`
}
...
type RoleTemplate struct {
	...
	RoleType      role.RoleType     `json:"roleType"`
...
type RoleExportFilter struct {
	RoleTypes          []role.RoleType `json:"roleTypes,omitempty"`
...
func (s *roleService) CreateRole(ctx context.Context, input CreateRoleInput) (*model.Role, error) {
...
func (s *roleService) UpdateRole(ctx context.Context, id xid.ID, input UpdateRoleBody) (*model.Role, error) {
...
func (s *roleService) GetRoleByName(ctx context.Context, name string, roleType role.RoleType, organizationID *xid.ID, applicationID *xid.ID) (*model.Role, error) {
...
func (s *roleService) ListRoles(ctx context.Context, params ListRolesParams) (*model.PaginatedOutput[*model.Role], error) {
...
func (s *roleService) GetSystemRoles(ctx context.Context, params ListRolesParams) (*model.PaginatedOutput[*model.Role], error) {
...
func (s *roleService) GetOrganizationRoles(ctx context.Context, organizationID xid.ID, params ListRolesParams) (*model.PaginatedOutput[*model.Role], error) {
...
func (s *roleService) GetApplicationRoles(ctx context.Context, applicationID xid.ID, params ListRolesParams) (*model.PaginatedOutput[*model.Role], error) {
...
func (s *roleService) GetDefaultRoles(ctx context.Context, roleType role.RoleType, organizationID *xid.ID, applicationID *xid.ID) ([]*model.Role, error) {
...
func (s *roleService) GetDefaultRoleForUserType(ctx context.Context, userType string, roleType role.RoleType, organizationID *xid.ID) (*model.Role, error) {
...
func (s *roleService) ValidateRoleName(ctx context.Context, name string, roleType role.RoleType, organizationID *xid.ID) error {
	if name == "" {
...
func (s *roleService) GetRoleTemplates(ctx context.Context, roleType role.RoleType) ([]RoleTemplate, error) {
...
func (s *roleService) BulkCreateRoles(ctx context.Context, inputs []CreateRoleInput) ([]*model.Role, []error) {
