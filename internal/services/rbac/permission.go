...
type PermissionService interface {
	...
	SearchPermissions(ctx context.Context, query string, params SearchPermissionsParams) (*model.PaginatedOutput[*model.Permission], error)

	// Permission categorization
	GetPermissionsByCategory(ctx context.Context, category permission.Category, params ListPermissionsParams) (*model.PaginatedOutput[*model.Permission], error)
	GetPermissionsByGroup(ctx context.Context, group string, params ListPermissionsParams) (*model.PaginatedOutput[*model.Permission], error)
	GetPermissionsByResource(ctx context.Context, resource string, params ListPermissionsParams) (*model.PaginatedOutput[*model.Permission], error)
	GetSystemPermissions(ctx context.Context, params ListPermissionsParams) (*model.PaginatedOutput[*model.Permission], error)
	GetDangerousPermissions(ctx context.Context, params ListPermissionsParams) (*model.PaginatedOutput[*model.Permission], error)
	...
	// Bulk operations
	BulkCreatePermissions(ctx context.Context, inputs []CreatePermissionInput) ([]*model.Permission, []error)
...
type SearchPermissionsParams struct {
	...
	UserTypes        []string
	Contexts         []string
	IncludeSystem    model.OptionalParam[bool]
	IncludeDangerous model.OptionalParam[bool]
	ExcludeInactive  model.OptionalParam[bool]
}
...
type BulkPermissionUpdate struct {
	ID    xid.ID                `json:"id"`
	Input UpdatePermissionInput `json:"input"`
}
...
type PermissionExportFilter struct {
	Categories    []permission.Category `json:"categories,omitempty"`
...
func (s *permissionService) CreatePermission(ctx context.Context, input CreatePermissionInput) (*model.Permission, error) {
...
func (s *permissionService) UpdatePermission(ctx context.Context, id xid.ID, input UpdatePermissionInput) (*model.Permission, error) {
...
func (s *permissionService) ListPermissions(ctx context.Context, params ListPermissionsParams) (*model.PaginatedOutput[*model.Permission], error) {
...
func (s *permissionService) SearchPermissions(ctx context.Context, query string, params SearchPermissionsParams) (*model.PaginatedOutput[*model.Permission], error) {
...
func (s *permissionService) GetPermissionsByCategory(ctx context.Context, category permission.Category, params ListPermissionsParams) (*model.PaginatedOutput[*model.Permission], error) {
	var includeRoles *bool
	if params.IncludeRoles.IsSet {
		includeRoles = &params.IncludeRoles.Value
	}
	result, err := s.permissionRepo.GetByCategory(ctx, category, repository.ListPermissionsParams{
		PaginationParams: params.PaginationParams,
...
func (s *permissionService) GetPermissionsByGroup(ctx context.Context, group string, params ListPermissionsParams) (*model.PaginatedOutput[*model.Permission], error) {
	var includeRoles *bool
	if params.IncludeRoles.IsSet {
		includeRoles = &params.IncludeRoles.Value
	}

	result, err := s.permissionRepo.GetByGroup(ctx, group, repository.ListPermissionsParams{
		PaginationParams: params.PaginationParams,
		IncludeRoles:     includeRoles,
	})
	if err != nil {
...
func (s *permissionService) GetPermissionsByResource(ctx context.Context, resource string, params ListPermissionsParams) (*model.PaginatedOutput[*model.Permission], error) {
	var includeRoles *bool
	if params.IncludeRoles.IsSet {
		includeRoles = &params.IncludeRoles.Value
	}

	result, err := s.permissionRepo.GetByResource(ctx, resource, repository.ListPermissionsParams{
		PaginationParams: params.PaginationParams,
		IncludeRoles:     includeRoles,
	})
	if err != nil {
...
func (s *permissionService) GetSystemPermissions(ctx context.Context, params ListPermissionsParams) (*model.PaginatedOutput[*model.Permission], error) {
	var includeRoles *bool
	if params.IncludeRoles.IsSet {
		includeRoles = &params.IncludeRoles.Value
	}

	result, err := s.permissionRepo.GetSystemPermissions(ctx, repository.ListPermissionsParams{
		PaginationParams: params.PaginationParams,
		IncludeRoles:     includeRoles,
	})
	if err != nil {
...
func (s *permissionService) GetDangerousPermissions(ctx context.Context, params ListPermissionsParams) (*model.PaginatedOutput[*model.Permission], error) {
	var includeRoles *bool
	if params.IncludeRoles.IsSet {
		includeRoles = &params.IncludeRoles.Value
	}

	result, err := s.permissionRepo.GetDangerousPermissions(ctx, repository.ListPermissionsParams{
		PaginationParams: params.PaginationParams,
		IncludeRoles:     includeRoles,
	})
	if err != nil {
...
func (s *permissionService) BulkCreatePermissions(ctx context.Context, inputs []CreatePermissionInput) ([]*model.Permission, []error) {
