...
type Invoice struct {
	...
	Status          string                 `json:"status" example:"paid" doc:"Invoice status" enum:"draft,open,paid,void,uncollectible"`
...
type ListInvoicesParams struct {
	PaginationParams
	Status    string                   `json:"status,omitempty" query:"status" example:"paid" doc:"Filter by status" enum:"draft,open,paid,void,uncollectible"`
	...
	SortBy    string                   `json:"sortBy,omitempty" query:"sortBy" example:"createdAt" doc:"Sort field" enum:"createdAt,dueDate,amount,status"`
...
type ListBillingHistoryParams struct {
	...
	SortBy    string     `json:"sortBy,omitempty" query:"sortBy" example:"createdAt" doc:"Sort field" enum:"createdAt,amount,status"`
	SortOrder string     `json:"sortOrder,omitempty" query:"sortOrder" example:"desc" doc:"Sort order" enum:"asc,desc"`
}
