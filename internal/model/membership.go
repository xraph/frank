...
type Membership struct {
	...
	Status           membership.Status      `json:"status" example:"active" doc:"Membership status (pending, active, inactive, suspended)" enum:"active,inactive,suspended,pending"`
...
type MembershipSummary struct {
	...
	Status           membership.Status `json:"status" example:"active" doc:"Membership status"`
...
type ListMembershipsParams struct {
	...
	Status           OptionalParam[membership.Status] `json:"status,omitempty"`
...
type RoleSummary struct {
	...
	RoleType    role.RoleType `json:"roleType" example:"admin" doc:"Role type"`
...
type BulkMemberStatusUpdate struct {
	UserID      xid.ID            `json:"userId" example:"01FZS6TV7KP869DR7RXNEHXQKX" doc:"User ID" required:"true"`
	Status      membership.Status `json:"status,omitempty" example:"active" doc:"Status of the membership" required:"true"`
	Reason      string            `json:"reason,omitempty" example:"Bulk operation" doc:"Reason for operation"`
	NotifyUsers bool              `json:"notifyUsers" example:"false" doc:"Whether to notify affected users"`
}
...
type MembershipChange struct {
	...
	NewStatus   *membership.Status     `json:"newStatus,omitempty" example:"active" doc:"New status (for status changes)"`
