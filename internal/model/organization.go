...
type Organization struct {
	...
	OrgType                organization.OrgType   `json:"orgType" example:"customer" doc:"Organization type (platform, customer)"`
...
type OrganizationSummary struct {
	...
	Plan        string               `json:"plan" example:"pro" doc:"Subscription plan"`
	Active      bool                 `json:"active" example:"true" doc:"Whether organization is active"`
	OrgType     organization.OrgType `json:"orgType" example:"customer" doc:"Organization type"`
...
type OrganizationListRequest struct {
	PaginationParams
	OrgType    organization.OrgType  `json:"orgType,omitempty" query:"orgType" example:"customer" doc:"Filter by organization type"`
