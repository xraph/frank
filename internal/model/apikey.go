...
type APIKeyListRequest struct {
	...
	Scope          string                `json:"scope,omitempty" example:"api:read" doc:"Filter by scope" query:"scope"`
}
...
type APIKeyActivityRequest struct {
	PaginationParams
	KeyID      *xid.ID    `json:"keyId,omitempty" example:"01FZS6TV7KP869DR7RXNEHXQKX" doc:"Filter by API key" query:"keyId"`
	...
	Success    *bool      `json:"success,omitempty" example:"true" doc:"Filter by success status" query:"success"`
	StartDate  *time.Time `json:"startDate,omitempty" example:"2023-01-01T00:00:00Z" doc:"Start date" query:"startDate"`
	EndDate    *time.Time `json:"endDate,omitempty" example:"2023-01-31T23:59:59Z" doc:"End date" query:"endDate"`
