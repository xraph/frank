...
type UpdateIdentityProviderRequest struct {
	...
	Config           *IdentityProviderConfig `json:"config,omitempty" doc:"Updated configuration"`
...
// EnableProviderRequest represents a request to enable a provider for an organization
...
type ProviderCatalogListRequest struct {
	...
	Popular         *bool  `json:"popular,omitempty" example:"true" doc:"Filter by popularity" query:"popular"`
	Search          string `json:"search,omitempty" example:"google" doc:"Search in name/description" query:"search"`
	IncludeInactive bool   `json:"includeInactive,omitempty" example:"false" doc:"Include inactive templates" query:"includeInactive"`
}
...
type OrganizationProviderListRequest struct {
	...
	Enabled        *bool  `json:"enabled,omitempty" example:"true" doc:"Filter by enabled status" query:"enabled"`
...
var QuickSetupTemplates = map[string]EnableProviderRequest{
	"google_workspace": {
		TemplateKey:   "google",
