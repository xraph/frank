...
type Role struct {
	...
	RoleType            role.RoleType  `json:"roleType" example:"organization" doc:"Role type (system, organization, application)"`
...
type CreateRoleRequest struct {
	...
	RoleType            string   `json:"roleType" example:"organization" doc:"Role type"`
...
type CreatePermissionRequest struct {
	...
	Category            string   `json:"category" example:"content" doc:"Permission category"`
...
type RoleListRequest struct {
	...
	Limit           int     `json:"limit,omitempty" example:"50" doc:"Maximum results"`
	Offset          int     `json:"offset,omitempty" example:"0" doc:"Results offset"`
	SortBy          string  `json:"sortBy,omitempty" example:"priority" doc:"Sort field"`
	SortOrder       string  `json:"sortOrder,omitempty" example:"desc" doc:"Sort order"`
...
type UserPermissionsRequest struct {
	UserID           xid.ID  `json:"userId" example:"01FZS6TV7KP869DR7RXNEHXQKX" doc:"User ID"`
	ContextType      string  `json:"contextType,omitempty" example:"organization" doc:"Filter by context type"`
...
type PermissionStats struct {
	...
	CategoryBreakdown    map[permission.Category]int `json:"categoryBreakdown" doc:"Category breakdown"`
