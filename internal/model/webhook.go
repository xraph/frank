...
type Webhook struct {
	...
	Format         webhook.Format         `json:"format" example:"json" doc:"Payload format (json, form)" enum:"json,form"`
...
type CreateWebhookRequest struct {
	...
	Format     string                 `json:"format,omitempty" example:"json" doc:"Payload format"`
