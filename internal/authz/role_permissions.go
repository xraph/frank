...
var BaseRolePermissions = RolePermissions{
	RoleSystemAdmin: {
		...
		PermissionManageSystemPermission, PermissionManagePermission,
	...
	RoleAdmin: {
		...
		PermissionManageSession, PermissionDeleteSession,
		PermissionManageWebhooks, PermissionDeleteWebhook,
		PermissionManageWebhookEvent, PermissionDeleteWebhookEvent,
		PermissionManageEmailTemplate, PermissionDeleteEmailTemplate,
		PermissionManageRole, PermissionDeleteRole, PermissionAssignRole,
	...
	RoleMember: {
		...
		PermissionWriteAPIKey, PermissionWriteAPIKey,
		PermissionWriteWebhook, PermissionWriteWebhook,
		PermissionWriteWebhookEvent,
		PermissionWriteEmailTemplate, PermissionWriteEmailTemplate,
		PermissionWriteRole, PermissionWriteRole,
		PermissionWriteMFA, PermissionWriteMFA,
		PermissionWriteVerification, PermissionWriteVerification,
	},
	RoleViewer: {
		// Viewer-specific permissions (those not in Guest)
		PermissionViewOrganization, PermissionViewMembers,
		PermissionReadUser, PermissionListUsers,
		PermissionReadAPIKey, PermissionReadAPIKey,
		PermissionReadSessions, PermissionReadSessions,
		PermissionReadWebhook, PermissionReadWebhook,
		PermissionReadWebhookEvents, PermissionReadWebhookEvents,
		PermissionReadEmailTemplate, PermissionReadEmailTemplate,
		PermissionReadRole, PermissionReadRole,
		PermissionReadPermission, PermissionReadPermission,
		PermissionReadMFA, PermissionReadMFA,
		PermissionReadVerification, PermissionReadVerification,
	},
	RoleGuest: {
		// Base permissions for all authenticated users
		PermissionViewSelf, PermissionUpdateSelf, PermissionManageSelf,
		PermissionViewPersonalAPIKey, PermissionManagePersonalAPIKey,
		PermissionViewPersonalSession, PermissionManagePersonalSession,
