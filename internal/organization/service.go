...
type Service interface {
	...
	Get(ctx context.Context, id string) (*ent.Organization, error)
	...
	Update(ctx context.Context, id string, input UpdateOrganizationInput) (*ent.Organization, error)

	// Delete deletes an organization
	Delete(ctx context.Context, id string) error

	// GetMembers retrieves members of an organization
	GetMembers(ctx context.Context, orgID string, params ListParams) ([]*ent.User, int, error)
...
// Get retrieves an organization by ID
func (s *service) Get(ctx context.Context, id string) (*ent.Organization, error) {
...
// Update updates an organization
func (s *service) Update(ctx context.Context, id string, input UpdateOrganizationInput) (*ent.Organization, error) {
...
// GetMembers retrieves members of an organization
func (s *service) GetMembers(ctx context.Context, orgID string, params ListParams) ([]*ent.User, int, error) {
	// Set default limit if not provided
	if params.Limit <= 0 {
		params.Limit = 10
	}
...
// AddMember adds a user to an organization
func (s *service) AddMember(ctx context.Context, orgID, userID string, roles []string) error {
...
// UpdateMember updates a member's roles in an organization
func (s *service) UpdateMember(ctx context.Context, orgID, userID string, roles []string) error {
	return s.repo.UpdateMember(ctx, orgID, userID, roles)
}

// IsFeatureEnabled checks if a feature is enabled for an organization
func (s *service) IsFeatureEnabled(ctx context.Context, orgID string, featureKey string) (bool, error) {
	return s.repo.IsFeatureEnabled(ctx, orgID, featureKey)
}

// GetFeatures retrieves features of an organization
func (s *service) GetFeatures(ctx context.Context, orgID string) ([]*ent.OrganizationFeature, error) {
	return s.repo.GetFeatures(ctx, orgID)
}

// EnableFeature enables a feature for an organization
func (s *service) EnableFeature(ctx context.Context, orgID string, featureKey string, settings map[string]interface{}) error {
	return s.repo.EnableFeature(ctx, orgID, featureKey, settings)
}

// DisableFeature disables a feature for an organization
func (s *service) DisableFeature(ctx context.Context, orgID string, featureKey string) error {
