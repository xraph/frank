...
type PasswordManager interface {
	...
	CreateResetToken(ctx context.Context, userID string, expiresIn time.Duration) (*ent.Verification, error)
...
// CreateResetToken creates a password reset token
func (p *passwordManager) CreateResetToken(ctx context.Context, userID string, expiresIn time.Duration) (*ent.Verification, error) {
