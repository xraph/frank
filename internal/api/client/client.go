...
// APIClient manages communication with the Frank Auth Server API API v1.0.0
...
type APIClient struct {
	...
	PasskeysApi *PasskeysApiService

	PasswordlessApi *PasswordlessApiService
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	c.PasskeysApi = (*PasskeysApiService)(&c.common)
	c.PasswordlessApi = (*PasswordlessApiService)(&c.common)
