...
/*
SessionApiService Delete session
Delete a specific session for the current user
  - @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
  - @param id
*/
func (a *SessionApiService) DeleteUserSession(ctx context.Context, id string) (*http.Response, error) {
	var (
...
/*
SessionApiService Get user sessions
Get the active sessions for the current user
  - @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().

@return InlineResponse20021
*/
func (a *SessionApiService) GetUserSessions(ctx context.Context) (InlineResponse20021, *http.Response, error) {
	var (
