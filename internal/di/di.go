...
// Container defines the interface for accessing all services and components within the application
type Container interface {
	...
	AuthZ() *authz.PermissionsService
...
func (d *containerImpl) AuthZ() *authz.PermissionsService {
	return d.authz
}
...
func NewContainer(
	...
	authzServ := authz.NewPermissionsService(client)
