...
func (rc *RBACCommands) createRole(cmd *cobra.Command, args []string) error {
	...
	role, err := rbacService.CreateRole(rc.base.Ctx, model.CreateRoleRequest{
		Name:        name,
		DisplayName: displayName,
		Description: description,
		RoleType:    model.RoleType(roleType),
	})
	if err != nil {
...
func (rc *RBACCommands) assignRole(cmd *cobra.Command, args []string) error {
	...
	user, err := userService.GetUserByIdentifier(rc.base.Ctx, userEmail, model.UserTypeEndUser)
	if err != nil {
...
func (rc *RBACCommands) listUserRoles(cmd *cobra.Command, args []string) error {
	...
	rbacService := rc.base.Container.RBACService()
	roles, err := rbacService.GetUserRoles(rc.base.Ctx, user.ID)
	if err != nil {
